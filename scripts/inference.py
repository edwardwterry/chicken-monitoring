...
class Detection():
    def __init__(self):
        ...
        self.to_run = rospy.get_param('to_run')
        ...
        for image_type in [x for x in self.to_run.keys() if self.to_run[x]]:
    ...
    def color_clbk(self, msg):
        ...
        self.curr_color = copy.deepcopy(msg)
        if self.to_run['color']:
